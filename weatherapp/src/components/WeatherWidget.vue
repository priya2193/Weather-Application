<template>
    <div>
        ...
        <div class="subtitle has-text-centered">
            <a href = "#" @click="toggleSeen">
                <h1 class="title">Click to get detailed forecast for: {{ location }}</h1>
            </a>
        </div>
        <hr>
        <div class="heading" v-if="seen">
            <h1 class="title">5 days forecast for : {{ location }}</h1>
        </div>
        <h2 class="subtitle has-text-centered" v-if="seen">Filter by date</h2>
        <div class="tabs is-centered is-medium is-toggle" v-if="seen">
            <ul>
        ...
        <div v-for="(weatherItem, index) in foreCastListByDate" v-if="seen">
